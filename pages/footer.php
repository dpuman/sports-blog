            ...
            <div class="row py-5">
                ...
                <div class="col-md-3">
                    ...
                    <ul class="navbar-nav text-white">
                        <li><a href="index.html" class="nav-link pt-0 pb-1">Home</a></li>
                        <li><a href="cricket.html" class="nav-link pt-0 pb-1">Cricket</a></li>
                        <li><a href="football.html" class="nav-link pt-0 pb-1">Football</a></li>
                        <li><a href="about-us.html" class="nav-link py-1">About Us</a></li>
                        <li><a href="contact-us.html" class="nav-link py-1">Contact</a></li>
                    </ul>
                </div>
        ...
        <div class="container-fluid">
            <div class="row pb-5">
                ...
                <div class="col-md-7 px-5">
                    <span class="float-start text-white ">©</span><span class="text-color float-start">sportsnews.com.</span><span class="fw-bold text-white float-start"> All Rights Reserved. Designed by </span><a href="" class="nav-link ms-1 float-start text-color">BITM</a>
                </div>
